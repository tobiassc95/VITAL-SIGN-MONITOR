...
uint16_t UARTreadMSG(uint8_t uart_, char* msg, uint16_t Nbytes); //when receive.
uint8_t UARTwriteMSG(uint8_t uart_, const char* msg, uint16_t Nbytes); //When transmit.
